...
--------
RegisterCommand("fwstatus", function()
...
RegisterNetEvent('lhdc_fogoArtificio:returnFireworkingStatus')
AddEventHandler('lhdc_fogoArtificio:returnFireworkingStatus', function(status)
    fireworking = status
end)
loadedClient = false
Citizen.CreateThread(function() --Starts Fireworks if player joins during event
	while not loadedClient do
		...
		if NetworkIsSessionStarted() then
			TriggerServerEvent('lhdc_fogoArtificio:isFireworking')
            loadedClient = true
		end
	end
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        if(fireworking)then
            ...
            if(Config.SpawnFireworksInMazeBank.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos3[1] + math.random(-100, 100), pos3[2] + math.random(-100, 100), pos3[3] + 25 + math.random(100, 150), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInRedBridge.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos4[1] + math.random(-100, 100), pos4[2] + math.random(-100, 100), pos4[3] + 25 + math.random(100, 150), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInRichardsMajestic.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos5[1] + math.random(-100, 100), pos5[2] + math.random(-100, 100), pos5[3] + 25 + math.random(100, 150), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInObservatory.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos6[1] + math.random(-100, 100), pos6[2] + math.random(-100, 100), pos6[3] + 25 + math.random(100, 150), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInYacht.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos7[1] + math.random(-100, 100), pos7[2] + math.random(-100, 100), pos7[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInSandyShores.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos8[1] + math.random(-100, 100), pos8[2] + math.random(-100, 100), pos8[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInMRC.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos9[1] + math.random(-50, 50), pos9[2] + math.random(-50, 50), pos9[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInChiliad.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos10[1] + math.random(-50, 50), pos10[2] + math.random(-50, 50), pos10[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInRoxwood.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos11[1] + math.random(-50, 50), pos11[2] + math.random(-50, 50), pos11[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInJuniperByTheShore.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos12[1] + math.random(-50, 50), pos12[2] + math.random(-50, 50), pos12[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInMarinaBeachLightHouse.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos13[1] + math.random(-50, 50), pos13[2] + math.random(-50, 50), pos13[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInElGordoDrive.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos14[1] + math.random(-50, 50), pos14[2] + math.random(-50, 50), pos14[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInMountJosiah.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos15[1] + math.random(-50, 50), pos15[2] + math.random(-50, 50), pos15[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInCargoShip.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos16[1] + math.random(-50, 50), pos16[2] + math.random(-50, 50), pos16[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
            if(Config.SpawnFireworksInCayoPerico.enabled)then
                UseParticleFxAssetNextCall(asset2)
                local part = StartParticleFxNonLoopedAtCoord("scr_firework_indep_spiral_burst_rwb", pos17[1] + math.random(-50, 50), pos17[2] + math.random(-50, 50), pos17[3] + 25 + math.random(50, 100), 0.0, 0.0, 0.0, 2.0, false, false, false)
            end
